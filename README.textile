...
Plugin is avaliable only for Elasticsearch 7.5.0.

|_. Morphological Analysis Plugin |_.  Elasticsearch   |_. URL  |
| 7.5.0                           | 7.5.0   | build yourself: gradlew build |
...
Also, if you not know how build the plugin, the compiled version is added (analysis-morphology-7.5.0.zip)
